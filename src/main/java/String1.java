...
public class String1
{
    ...
    public String firstHalf(String str) {
        return str.substring(0,(str.length()-1) / 2 + 1);
    }
    ...
    public boolean hasBad(String str) {
        String check1 = str.substring(0,3);
        String check2 = str.substring(1,4);
        if(check1.equals("bad")||check2.equals("bad")){
           return true; 
        }else{ 
            return false;
    }
    ...
    public String conCat(String a, String b) {
        String checkA = a.substring(a.length()-1);
        String checkB = "";
        if(false == b.equals("")){
           checkB = b.substring(0,1); 
        }
    ...
    public String minCat(String a, String b) {
        ...
        if(a.length() > b.length()){
           ...
           return a.substring(diference) + b;
        }else{
            diference = b.length() - a.length();
            return a + b.substring(diference);
        }
    }
